...
const seedDB = async () => {
  ...
  for (let i = 0; i < 50; ++i) {
    ...
    const camp = new Campground({
      ...
      description:
        'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos minus eum, temporibus ducimus, ipsum veniam eaque quaerat necessitatibus voluptates numquam sint doloremque doloribus optio consectetur. Laudantium odit tempore delectus ea.',
      price,
      geometry: {
        type: 'Point',
        coordinates: [
